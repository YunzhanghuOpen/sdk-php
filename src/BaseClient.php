...
class BaseClient
{
    ...
    protected static $env_service_host_map = array(
        self::ENV_PROD => array( // 正式环境
            ...
            'walletincome' => 'https://api-service.yunzhanghu.com', // 钱包余额入账接口域名
            'walletbalancequery' => 'https://api-service.yunzhanghu.com', // 钱包余额查询接口域名
            'walletdeduct' => 'https://api-service.yunzhanghu.com', // 钱包余额扣减接口域名
            'walletwithdraw' => 'https://api-service.yunzhanghu.com', // 钱包余额提现接口域名
        ...
        self::ENV_SANDBOX => array( // 沙箱环境
            ...
            'realnameservice' => 'https://api-user.yunzhanghu.com/sandbox', // 用户实名认证信息收集接口域名
            'taxclearrefund' => 'https://api-service.yunzhanghu.com/sandbox', // 连续劳务税费退补接口域名
            'walletincome' => 'https://api-service.yunzhanghu.com/sandbox', // 钱包余额入账接口域名
            'walletbalancequery' => 'https://api-service.yunzhanghu.com/sandbox', // 钱包余额查询接口域名
            'walletdeduct' => 'https://api-service.yunzhanghu.com/sandbox', // 钱包余额扣减接口域名
            'walletwithdraw' => 'https://api-service.yunzhanghu.com/sandbox', // 钱包余额提现接口域名
            'ins' => '',       // 保险服务接口域名
